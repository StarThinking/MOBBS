...
namespace librbd {
  ...
  int ImageCtx::initialize_WHOBBS()
  {
    cout << "initialize WHOBBS" << std::endl;
  ...
  {
    md_ctx[HDD_POOL].dup(p0);
    data_ctx[HDD_POOL].dup(p0);
    md_ctx[SSD_POOL].dup(p1);
    data_ctx[SSD_POOL].dup(p1);
