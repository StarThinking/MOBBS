...
#seq-test write /dev/vdb seq-write-hdd
#seq-test write /dev/vdc seq-write-ssd

ran-test read /dev/vdb ran-read-hdd
ran-test read /dev/vdc ran-read-ssd

seq-test read /dev/vdb seq-read-hdd
seq-test read /dev/vdc seq-read-ssd
